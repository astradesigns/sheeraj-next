...
export default function Sustainability() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#06262f] via-[#0a3a36] to-[#1a2f33] py-28 md:py-36">
      {/* sunset wash */}
      ...
      <PalmFrond className="absolute -left-4 bottom-0 z-0 h-60 w-40 rotate-[20deg] text-lagoon/10 anim-sway-soft" />
